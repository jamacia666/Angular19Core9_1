...
namespace PeliculasAPI.Controllers
{
    ...
    public class PeliculasController : CustomBaseController
    {
        ...
        public PeliculasController(AplicationDbContext context, IMapper mapper,
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromForm] PeliculasCreacionDTO peliculaCreacionDTO)
        {
